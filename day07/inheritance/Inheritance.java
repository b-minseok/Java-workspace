...
public class Inheritance {
	...
	public static void main(String[] args) {
		//1. Human객체 생성해서 이름, 키 값을 할당하고 showInfo()호출하세요
		Human h=new Human();
		h.name="아무개";
		h.height=166;
		
		h.showInfo();
		//2.Superman객체 생성해서 이름, 키, 초능력 값을 할당하고
		//showInfo()호출하세요
		System.out.println("-------------");
		...
		//Human 타입의 변수 선언하고 Aquaman객체를 생성해서
		...
		//그런 뒤 반복문 이용해서 배열에 저장된 객체들의 showInfo()를 호출하세요
		Human[] arr= {h, s, a, hs, ha};
