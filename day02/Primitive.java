package day02;
//import java.lang.System;//java.lang패키지 import문은 생략해도 된다=>자동으로 import함
...
public class Primitive {
	...
	public static void main(String[] args) {
		...
		//자료형 변수명 = 값(literal)
		byte bt1 = -128; //1byte (8bit) -2^7 ~ 2^7-1 (-128 ~ 127)
		byte bt2 = 127;
		System.out.println("bt1="+bt1);
		//System.out.println=syso+ctrl+스페이스바
		System.out.println("bt2="+bt2);
		//3000
		short st1=3000;//2byte//(16bit) -2^15 ~ 2^15-1
		short st2=-5578;
